...
Version: 20120615
Release: 6%{?dist}
Summary: An NCurses display manager (PAM enabled version)
License: GPL
URL: https://github.com/ShadowKyogre/NCDM
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
BuildRequires: 
Requires: python-urwid xorg-xinit coreutils grep kbd pypam
%description An NCurses display manager (PAM enabled version)

%prep
%setup -qn %_builddir/ncdm-pam-git-20120615 -c %_builddir/ncdm-pam-git-20120615
